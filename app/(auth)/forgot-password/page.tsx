    ...
    return (
      <PageWrapper>
        ...
        <form onSubmit={handleSendOtp} className="space-y-6">
          <div>
            ...
            <input
              ...
              className={`w-full rounded-lg border px-4 py-3 text-gray-800 placeholder-gray-400 outline-none transition-all ${emailError ? "border-rose-400 focus:ring-2 focus:ring-rose-100" : "border-gray-200 focus:border-orange-500"}`}
            />
        ...
        <p className="mt-8 text-center text-sm text-gray-600">
          ...
          <Link href="/sign-in" className="font-semibold text-orange-600 hover:text-orange-500 transition-colors">Sign In</Link>
        </p>
      </PageWrapper>
    );
  }
      ...
      <PageWrapper>
        ...
        <form onSubmit={handleVerifyOtp} className="space-y-6">
              ...
              {otp.map((digit, index) => (
                <input
                  ...
                  className={`w-11 h-13 sm:w-12 sm:h-14 text-center text-xl font-bold border rounded-lg outline-none transition-all ${digit
                    ...
                    : "bg-white border-gray-200 text-slate-800 focus:border-orange-500"
                    }`}
                />
              ))}
            </div>
          ...
          <div className="text-center lg:text-left">
            {countdown > 0 ? (
              <p className="text-sm text-gray-500">Resend code in <span className="font-semibold text-orange-500">{countdown}s</span></p>
            ) : (
              <button type="button" onClick={handleResend} disabled={isResending} className="inline-flex items-center gap-1.5 text-sm font-semibold text-orange-600 hover:text-orange-500 transition disabled:opacity-60">
        ...
        <p className="mt-8 text-center text-sm text-gray-600">
          Wrong email?{" "}
          <button onClick={() => setStep("email")} className="font-semibold text-orange-600 hover:text-orange-500 transition-colors">Go back</button>
        </p>
      </PageWrapper>
    );
  }
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full rounded-lg border pr-10 px-4 py-3 text-gray-800 placeholder-gray-400 outline-none transition-all ${passwordErrors.tooShort ? "border-rose-400" : "border-gray-200 focus:border-orange-500"}`}
              />
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full rounded-lg border pr-10 px-4 py-3 text-gray-800 placeholder-gray-400 outline-none transition-all ${passwordErrors.noMatch ? "border-rose-400" : "border-gray-200 focus:border-orange-500"}`}
              />
